export const A28_HUMAN_WITNESS_READY_EVENT = 'piui:a28-human-witness-ready';
...
export function assertA28HumanWitnessLease(value: unknown): A28HumanWitnessLease {
  if (!value || typeof value !== 'object' || Array.isArray(value)) {
    throw new Error('a28-human-witness-lease-rejected');
  }
  const lease = value as Record<string, unknown>;
  if (
    JSON.stringify(Object.keys(lease).sort()) !== JSON.stringify([...LEASE_KEYS].sort()) ||
